...
export class HandleWebSocketConnectionService {
  ...
  // public chatHistory: IMessageSocket[] = [];
  // public $chatHistorySubject = new BehaviorSubject<IMessageSocket[]>(this.chatHistory)
  ...
  public subscribeToPrivateChat(chatIdentity: string) {
    this.stompClient.subscribe(`/chat-private/${chatIdentity}`, (message: any) => {
      ...
      if (messageContent
        ...
        // this.chatHistory = [...this.chatHistory, messageContent]
